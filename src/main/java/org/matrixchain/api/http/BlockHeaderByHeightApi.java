...
@Component
public class BlockHeaderByHeightApi extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        BlockHeader header = matrixChainService.getBlockHeaderByHeight(height);

        resp.getWriter().print(JSONObject.toJSONString(new InvokeMessage<>(header)));
    }
