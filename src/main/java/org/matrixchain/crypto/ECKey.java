...
import org.matrixchain.crypto.jce.*;
...
public class ECKey implements Serializable {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(MatrixChainCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(
        MatrixChainCastleProvider.getInstance(),
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(MatrixChainCastleProvider.getInstance())
